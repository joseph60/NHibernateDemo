...
namespace DBUtility
{
    ...
    public abstract class SqlHelper
    {
        ...
        public static SqlTransaction CreateSqlTransaction(string connectionString)
        {
            SqlTransaction val = null;
            SqlConnection conn = new SqlConnection(connectionString);
            conn.Open();
        ...
        /// <param name="commandParameters"></param>
        /// <returns></returns>
        public static bool Exists(CommandType cmdType, string cmdText, SqlParameter[] commandParameters)
        {
            object obj = SqlHelper.ExecuteScalar(cmdType, cmdText, commandParameters);
            int cmdresult;
