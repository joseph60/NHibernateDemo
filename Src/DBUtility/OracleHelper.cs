...
namespace DBUtility
{
    ...
    public abstract class OracleHelper
    {
        ...
        #region CreateOracleTransaction

        public static OracleTransaction CreateOracleTransaction()
        {
            OracleTransaction val = null;
            OracleConnection conn = new OracleConnection(ConnectionString);
            conn.Open();
            val = conn.BeginTransaction();
            return val;
        }


        public static OracleTransaction CreateOracleTransaction(string connectionString)
        {
            OracleTransaction val = null;
            OracleConnection conn = new OracleConnection(connectionString);
            conn.Open();
